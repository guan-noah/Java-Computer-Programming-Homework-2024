...
import java.util.Scanner;
 ...
 public class GameData //static class 
 {
	...
	public static void setPlayerShake(boolean isShaking, int index)
	{
		gamePanel.setPlayerShake(isShaking, index);
	}
	...
	public static void writeHighScore()
	{
		...
		try
		{
			...
			write.println(enemiesDefeated + " enemies defeated");
			for(int i=0; i<playerChars.length; i++)
			{
				write.println(playerChars[i] + " - Level " + playerChars[i].getLevel());
			}

		...
		try
		{
			...
			while (read.hasNext())
			{
				...
				if(!line.equals(""))
				{
					...
					questionHeap.add(new Question(category, question, choices, answer, explanation));
				}
			}
		}
...
class Question
{
	...
	private String explanation; ///explanation for question
	private int answer; ///correct answer index
 
	public Question(String categoryIn, String questionIn, String[] choicesIn, int answerIn, String explanationIn)
	{
		category = categoryIn;
		question = questionIn;

...
public class ProblemPanel extends JPanel
{
	...
	public void getProblem()
	{
		...
		System.out.println("size: " + questionHeap.size());
		...
		public void checkQuestion(String toCheck)
		{
			...
			if(isCorrect)
			{
				...
				for(int i=0; i<options.length; i++)
				{
					...
					{
						content += " is correct because of " + explanations[i];
					}
					else
					{
						content += " is incorrect because of " + explanations[i];
					}
				}
    ...
    class ContentPanel extends JPanel
    {
		...
		public ContentPanel()
		{
			...
			JPanel categoryPanel = getCategoryHolder();
			JPanel problemHolder = getProblemHolder();

			add(categoryPanel, BorderLayout.NORTH);
			add(problemHolder, BorderLayout.CENTER);
		}

		public JPanel getCategoryHolder()
		{
		...
		public JPanel getProblemHolder()
		{
			JPanel toReturn = new JPanel(new BorderLayout());
			JScrollPane problemPane = getProblemPane();

			toReturn.setBackground(Color.GRAY);
			toReturn.add(problemPane);

			return toReturn;
		}

		public JScrollPane getProblemPane()
		{
			question = new JTextArea(30, 5);
			JScrollPane toReturn = new JScrollPane(question);

			question.setFont(new Font("Share Tech Regular", Font.BOLD, 30));
    ...
    class AnswerPanel extends JPanel
    {
		...
		public JRadioButton[] getRadioButtons()
		{
			...
			for(int i=0; i<toReturn.length; i++)
			{
				...
				toReturn[i].setFont(new Font("Oswald Regular", Font.BOLD, 20));

...
public class GeneticSorter
{
	private String[] genes;
	public GeneticSorter()
	{
		genes = new String[] {"rol", "try", "cod", "Pil", "dig", "tal", "mv"};
	}
	public static void main(String[] args)
	{
		GeneticSorter gs = new GeneticSorter();
		gs.fakeMain();
	}
	public void fakeMain()
	{
		...
		while(fileInput.hasNext())
		{
			...
			{
				System.err.println("Error: Unrecognized index of \':\' (not found)");
				//System.exit(3);
			}
			try
			{
			...
			{
				System.err.println("Error: label variable not initialized (" + e.getMessage() + ")");
				//System.exit(4);
			}

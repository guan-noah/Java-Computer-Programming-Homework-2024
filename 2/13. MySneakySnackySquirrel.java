...
This program (handed out in class) creates a game called SneakySnackySquirrel. 
*/

import java.util.Scanner;	//import library so have access to Scanner

public class MySneakySnackySquirrel	// write header
{
	private Player holly;
	public static void main(String[] args)			// write main header 
	{
		 MySneakySnackySquirrel squirrel = new MySneakySnackySquirrel(); //create an instance of the class SneakySnackySquirrel use it to call run
		 squirrel.run();
	}
	...
	public void info()
	{
		System.out.println("Welcome to SneakySnackySquirrel! \nIn this game," 
			+ "you will spin a number from 1 to 8; \n\tif you spin 1 to 5 you will gain " 
			+ "an acorn; \n\tif you spin 6 the wind blows and you will lose all acorns; "
			+ "\n\tif you spin 7 a sneaky squirrel will steal one acorn; "
			+ "finally, if you spin 8 you will gain 2 acorns. \n");
	}

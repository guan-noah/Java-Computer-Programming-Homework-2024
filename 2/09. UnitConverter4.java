...
Note: You cannot run this program by itself as it doesn't have a main method! You can only run this through UnitConverterTester4. 
...
Testing:
Any integer number greater than 0 should work.
Ex:	100 inches = 8.33 feet = 2.78 yards = 254.00 centimeters, 
 23.4 inches throws an error as it is not an integer. 
 any character throws an error
 24 inches = 2.00 feet = 0.67 yards = 60.96 centimeters 
*/
...
public class UnitConverter4   // class header
{
	...
	public UnitConverter4()	  // Constructor - used to initialize field variables.
	{
		inches = -1;
	}
	...
	// the # of ft
	public double inchesToFeet (int userInches)
	{
		final byte IN_TO_FT = 12;
		double ft = -1.2;	
		ft = (double)userInches/IN_TO_FT;	// calculate feet = inches/12.0
		return ft;
	}
	
	// calculates number of centimeters using the field variable inches then 
	// returns the cm
	public double inchesToCm (int userInches)
	{
		final double IN_TO_CM = 2.54;
		double centi = -5.0;
		centi = userInches*IN_TO_CM;		
		return centi;
	}
